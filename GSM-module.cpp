/*In this code we tried to properly integrate the GSM module with the ESP32 but due to some unknown reason we could not get proper signals on this module so this code wasn’t able to produce the desired output*/

#include <SoftwareSerial.h>

//sender phone number with country code
//const String PHONE = "+ZZxxxxxxxxxx";//For only 1 default number user
String PHONE = "+923322109876"; //For Multiple user
String msg;
